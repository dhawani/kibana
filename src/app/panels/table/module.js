  ...
  module.controller('table', function($rootScope, $scope, $modal, $q, $compile, $timeout,
    ...
    $scope.panelMeta = {
      ...
      editorTabs : [
        {
          title:'Formatting',
          src: 'app/panels/table/formatting.html'
        },
        {
          title:'Paging',
    ...
    var _d = {
      ...
      style   : {'font-size': '9pt'},
      normTimes : true,
      /** @scratch @scratch /panels/table/5
       * timeField:: This must be defined as a date type in Elasticsearch.
       */
      timeField : "@timestamp",
      /** @scratch @scratch /panels/table/5
       * timeFormatShort:: Short format for timeField. This will be displayed in table.
       */
      timeFormatShort : "yyyy-MM-dd HH:mm:ss",
      /** @scratch @scratch /panels/table/5
       * timeFormatLong:: Long format for timeField. This will be displayed in details.
       */
      timeFormatLong : "yyyy-MM-dd HH:mm:ss",
      /** @scratch /panels/table/5
       * ==== CSV
       * CSV object:: This object describes the csv options to use on this panel.
       * csv.header::: Whether to add headers to CSV file.
       * csv.allfields::: Whether to include all fields in CSV. If false, only displayed fields are added.
       */
      csv : {
        header : true,
        allfields : true
